...
export const tooltipVariants = tv({
  slots: {
    popup: [
      // base
      "z-50 flex origin-[var(--transform-origin)] flex-col rounded-md px-2 py-1 text-sm shadow-xl",
      // colors
  ...
  variants: {
    ...
    size: {
      sm: { popup: "px-2 py-1 text-xs" },
      default: { popup: "px-2 py-1 text-sm" },
      lg: { popup: "px-3 py-2 text-base" },
    },
  },
  defaultVariants: {
    variant: "default",
