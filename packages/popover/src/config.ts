...
export const popoverConfig: ComponentConfig = {
  ...
  featured: true,
  icon: MessageSquare,
  importStatement: `import { Popover, PopoverTrigger, PopoverContent, PopoverTitle, PopoverDescription, PopoverClose, PopoverArrow, PopoverBackdrop, PopoverPortal, PopoverPositioner } from "@patternmode/popover";`,
  examples: [
    {
      id: "default",
      title: "Default",
