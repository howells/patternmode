...
export const dropdownItemConfig: ComponentConfig = {
  ...
  name: "Dropdown Item",
  description:
    "A consistent dropdown item extending Button for use in menus and selects.",
  category: "controls",
  icon: undefined,
  ...
  examples: [
    {
      id: "basic",
      title: "Basic",
      description: "Simple items",
      component: DropdownItemBasicExample,
    },
    {
      id: "icons",
      title: "With Icons",
      description: "Icons on items",
      component: DropdownItemWithIconsExample,
    },
    {
      id: "states",
      title: "States",
      description: "Highlighted/selected/disabled",
  ...
  components: [
    {
      name: "Dropdown Item",
      description: "Menu option primitive",
