...
export const responsiveClassGenerators = {
   ...
   */
  display: (
    display: "block" | "flex" | "grid" | "inline" | "hidden"
  ): string => (display === "hidden" ? "hidden" : `${display}`),
...
export const createResponsiveClasses = {
   ...
   */
  direction: (
    value: ResponsiveValue<"vertical" | "horizontal"> | undefined
  ): string =>
  ...
  display: (
    value:
      | ResponsiveValue<"block" | "flex" | "grid" | "inline" | "hidden">
      | undefined
  ): string =>
   ...
   */
  textAlign: (
    value: ResponsiveValue<"left" | "center" | "right" | "justify"> | undefined
  ): string =>
