...
export const MultipleOpenExample = () => (
  <Accordion className="w-128 max-w-full" openMultiple>
    <AccordionItem value="item-1">
      <AccordionTrigger>What is Patternmode?</AccordionTrigger>
      <AccordionContent>
        Patternmode is a modern React component library that combines the best
    ...
    <AccordionItem value="mixed-trigger">
      ...
      <AccordionContent>
        <div className="space-y-2">
          ...
          <TextList className="ml-4" variant="marker">
            <TextListItem>List items with custom Text components</TextListItem>
            <TextListItem>
