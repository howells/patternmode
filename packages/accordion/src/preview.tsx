...
export const accordionPreviewProps = [
  ...
  },
  {
    ...
    defaultValue:
      "Patternmode is a modern React component library that combines the best design patterns and developer experience.",
  },
  {
    name: "triggerText2",
    type: "string",
  ...
  },
  {
    ...
    defaultValue:
      "You can install Patternmode components using npm or pnpm. Each component is built on Base UI primitives.",
  },
];
  ...
  return (
    ...
    >
      <AccordionItem value="item-1">
        ...
        <AccordionContent>{contentText1}</AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>{triggerText2}</AccordionTrigger>
        <AccordionContent>{contentText2}</AccordionContent>
      </AccordionItem>
    </Accordion>
  );
}
