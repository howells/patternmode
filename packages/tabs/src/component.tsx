...
const TabsList = ({
  ...
  <BaseTabs.List
    className={cx(
      variant === "solid"
        ? // Solid: white surface with thin border, no shadow (shared surface)
          cx(
            "group/tabslist relative inline-flex items-center gap-1",
            // Use shared floating surface in static context for parity
        ...
        : // Line: retain minimal line variant
...
const TabsTrigger = ({
  ...
  <BaseTabs.Tab
    className={cx(
      ...
      // Default active styles (no shadow)
