...
export const tabsConfig: ComponentConfig = {
  ...
  examples: [
    { id: "default", title: "Default", description: "Simple tabs", component: DefaultExample },
  ],
  components: [
    { name: "Tabs", description: "Tabs root", component: Tabs },
    { name: "TabsList", description: "Tabs list", component: TabsList },
    { name: "TabsTrigger", description: "Tabs trigger", component: TabsTrigger },
    { name: "TabsContent", description: "Tabs content", component: TabsContent },
  ],
};
