...
const MeterDocComponent: React.ComponentType<Partial<MeterProps>> = (props) =>
  React.createElement(Meter as React.ComponentType<MeterProps>, {
    value: 50,
    ...(props as Partial<MeterProps>),
  });
