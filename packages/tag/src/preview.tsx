...
export const tagPreviewProps = [
  { name: "label", type: "string", description: "Optional label", defaultValue: "" },
  { name: "value", type: "string", description: "Tag value", defaultValue: "Example" },
  { name: "count", type: "string", description: "Optional count", defaultValue: "" },
