...
export const DefaultExample = () => {
  ...
  return (
    <div className="max-w-md">
      ...
      <div className="mt-4 rounded-md bg-zinc-100 p-3 dark:bg-zinc-900">
...
export const SizesExample = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="mb-2 font-medium text-sm">Base (Default)</h3>
        <div className="max-w-md">
...
export const FormFieldsExample = () => {
  ...
  return (
    <div className="max-w-md">
      <h3 className="mb-3 font-medium text-sm">Select and order form fields</h3>
