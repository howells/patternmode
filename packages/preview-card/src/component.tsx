...
const PreviewCardTrigger = ({
  ...
  <BasePreviewCard.Trigger
    className={cx(
      ...
      // decoration
      "no-underline decoration-1 decoration-blue-600/60 underline-offset-2 dark:decoration-blue-400/60",
      // focus
...
type _PreviewCardPortalProps = React.ComponentPropsWithoutRef<
