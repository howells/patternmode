...
export const SpanningCellsExample = () => {
	return (
		<Grid columns={6} rows={3} gap={4}>
			<GridCell
				colSpan={2}
				className="bg-purple-100 dark:bg-purple-900 p-4 rounded text-center"
			>
				Span 2 cols
			</GridCell>
			<GridCell className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded text-center">
				3
			</GridCell>
			<GridCell className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded text-center">
				4
			...
			<GridCell
				rowSpan={2}
				className="bg-orange-100 dark:bg-orange-900 p-4 rounded text-center"
			>
				Span 2 rows
			</GridCell>
			<GridCell className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded text-center">
			...
			<GridCell
				colSpan={3}
				className="bg-yellow-100 dark:bg-yellow-900 p-4 rounded text-center"
			>
				Span 3 cols
			</GridCell>
			...
			<GridCell
				colStart={2}
				colSpan={2}
				className="bg-red-100 dark:bg-red-900 p-4 rounded text-center"
			>
				Start col 2
			</GridCell>
			<GridCell className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded text-center">
...
export const LayoutGridExample = () => {
	return (
		<Grid columns={12} gap={2} className="min-h-[300px]">
			...
			<GridCell
				colSpan={12}
				className="bg-blue-100 dark:bg-blue-900 p-4 rounded text-center"
			>
				Header
			</GridCell>
			...
			<GridCell
				colSpan={3}
				className="bg-green-100 dark:bg-green-900 p-4 rounded text-center"
			>
				Sidebar
			</GridCell>
			...
			<GridCell
				colSpan={9}
				className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded text-center"
			>
				Main Content
			</GridCell>
	...
	return (
		<Grid columns={4} gap={4} className="min-h-[250px]">
			...
			<GridCell
				colSpan={3}
				rowSpan={2}
				className="bg-white dark:bg-zinc-900 p-4 rounded text-center"
			>
				Analytics Chart
			</GridCell>
