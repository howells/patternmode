...
export const EXAMPLES: ComponentExample[] = [
  ...
  {
    id: "UserProfileExample",
    title: "User Profile",
    description: "User Profile example",
    component: UserProfileExample,
  },
  {
    id: "ProjectDetailsExample",
    title: "Project Details",
    description: "Project Details example",
    component: ProjectDetailsExample,
  },
  {
    id: "SystemInfoExample",
    title: "System Info",
    description: "System Info example",
    component: SystemInfoExample,
  },
  {
    id: "CompanyInfoExample",
    title: "Company Info",
    description: "Company Info example",
    component: CompanyInfoExample,
  },
  {
    id: "ProductSpecsExample",
    title: "Product Specs",
    description: "Product Specs example",
    component: ProductSpecsExample,
  },
  {
    id: "OrderDetailsExample",
    title: "Order Details",
    description: "Order Details example",
    component: OrderDetailsExample,
  },
  {
    id: "ApiEndpointExample",
    title: "Api Endpoint",
    description: "Api Endpoint example",
    component: ApiEndpointExample,
  },
  {
    id: "EventDetailsExample",
    title: "Event Details",
    description: "Event Details example",
    component: EventDetailsExample,
  },
  {
    id: "DescriptionListExample",
    title: "Description List",
    description: "Description List example",
