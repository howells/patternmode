				...
				return (
					<div className="p-4">
						<p className="text-sm text-zinc-600 dark:text-zinc-400">
							This is a simple drawer with basic content. Perfect for quick
							information display.
						</p>
					</div>
				);
	...
	return (
		<Drawer direction={direction}>
			<DrawerTrigger asChild>
				<Button variant={triggerVariant}>Open Drawer</Button>
			</DrawerTrigger>
			<DrawerContent>
				<DrawerHeader>
...
export const drawerPreviewProps = [
	{
		...
		type: "select",
		description:
			"Drawer opening direction - controls which side of the screen the drawer slides in from.",
	...
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show the drawer footer - displays action buttons at the bottom when enabled.",
		defaultValue: true,
	},
	{
