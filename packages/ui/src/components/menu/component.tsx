...
type MenuSubmenuTriggerProps = React.ComponentPropsWithoutRef<typeof BaseMenu.SubmenuTrigger> & {
  ref?: React.RefObject<React.ElementRef<typeof BaseMenu.SubmenuTrigger> | null>;
};

const MenuSubmenuTrigger = ({ ref: forwardedRef, className, children, ...props }: MenuSubmenuTriggerProps) => (
...
type MenuSubmenuContentProps = React.ComponentPropsWithoutRef<typeof BaseMenu.Popup> & {
  ref?: React.RefObject<React.ElementRef<typeof BaseMenu.Popup> | null>;
};

const MenuSubmenuContent = ({ ref: forwardedRef, className, ...props }: MenuSubmenuContentProps) => (
  <BaseMenu.Portal>
 ...
 */
const MenuContent = (
  { ref: forwardedRef, className, sideOffset = 8, collisionPadding = 8, align = "center", ...props }: MenuContentProps,
) => (
  <BaseMenu.Portal>
    <BaseMenu.Positioner
 ...
 */
const MenuItem = (
  { ref: forwardedRef, className, shortcut, hint, icon: Icon, children, ...props }: MenuItemProps,
) => (
  <BaseMenu.Item
    ref={forwardedRef}
    className={cx(
...
type MenuCheckboxItemProps = React.ComponentPropsWithoutRef<typeof BaseMenu.CheckboxItem> & {
  /**
   * Keyboard shortcut text displayed on the right side.
...
const MenuCheckboxItem = (
  { ref: forwardedRef, className, hint, shortcut, children, checked, ...props }: MenuCheckboxItemProps,
) => (
 ...
 */
const MenuRadioItem = ({ ref: forwardedRef, className, hint, shortcut, children, ...props }: MenuRadioItemProps) => (
  <BaseMenu.RadioItem
    ref={forwardedRef}
    className={cx(
      // base
...
type MenuLabelProps = React.ComponentPropsWithoutRef<typeof BaseMenu.GroupLabel> & {
 ...
 */
const MenuLabel = ({ ref: forwardedRef, className, ...props }: MenuLabelProps) => (
  <BaseMenu.GroupLabel
    ref={forwardedRef}
    className={cx(
      // base
 ...
 */
const MenuSeparator = ({ ref: forwardedRef, className, ...props }: MenuSeparatorProps) => (
  <BaseMenu.Separator
    ref={forwardedRef}
    className={cx(
