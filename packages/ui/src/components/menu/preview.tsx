...
export const menuPreviewProps = [
	{
		...
		type: "select",
		description:
			"Trigger button variant - controls the styling of the menu trigger button.",
	...
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show keyboard shortcuts - displays shortcut hints alongside menu items when enabled.",
		defaultValue: true,
	},
];
