...
export const toggleConfig: ComponentConfig = {
  ...
  examples: [
    ...
    },
    {
      ...
      description: "Toggle button with both icon and text, changing based on state",
    ...
    },
    {
      id: "sizes",
      title: "Sizes",
      description: "Toggle buttons in different sizes - small, default, and large",
      component: SizesExample,
    },
    {
      id: "play-pause",
      title: "Play/Pause",
      description: "Media control toggle switching between play and pause states",
    ...
    },
    {
      id: "disabled",
      title: "Disabled",
      description: "Toggle buttons in disabled state, both pressed and unpressed",
  ...
  components: [
    {
      name: "Toggle",
      description: "Two-state button for immediate toggle actions with visual feedback.",
      component: Toggle,
      primary: true,
    },
  ],
