...
export const sortableListConfig: ComponentConfig = {
  id: "sortable-list",
  name: "Sortable List",
  description: "A list component with drag-and-drop reordering and checkbox selection for managing ordered collections of items.",
  category: "inputs",
  icon: List,
  importStatement: `import { SortableList } from "@patternmode/ui/components/sortable-list";`,
  examples: [
    {
      id: "default",
      title: "Default",
