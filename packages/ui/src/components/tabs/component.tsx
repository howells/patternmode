...
const TabsList = ({
	...
	ref?: React.RefObject<React.ElementRef<typeof BaseTabs.List> | null>;
}) => {
...
const TabsTrigger = ({
	...
	ref?: React.RefObject<React.ElementRef<typeof BaseTabs.Tab> | null>;
}) => {
				...
				render={(tabProps, state) => {
					...
					return (
						<Button
							...
							className={cx("relative z-10", tabClassName, className)}
						>
							{children}
						</Button>
					);
