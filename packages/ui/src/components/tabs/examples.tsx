...
export const WithIconsExample = () => {
	return (
		<Tabs defaultValue="overview">
			<TabsList variant="line">
				<TabsTrigger value="overview" leftIcon={FileText}>
					Overview
				</TabsTrigger>
				<TabsTrigger value="analytics" leftIcon={BarChart3}>
					Analytics
				</TabsTrigger>
				<TabsTrigger value="users" leftIcon={Users}>
					Users
				</TabsTrigger>
				<TabsTrigger value="settings" leftIcon={Settings}>
					Settings
				</TabsTrigger>
			</TabsList>
			<TabsContent value="overview">
				<TabTextContent>
					Overview content with icons in line variant
				</TabTextContent>
			</TabsContent>
