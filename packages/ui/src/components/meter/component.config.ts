...
export const componentConfig: ComponentConfig = {
  id: "meter",
  name: "Meter",
  description: "A graphical meter component for displaying scalar values within a known range with visual progress indicators.",
  category: "feedback",
  icon: Activity,
  ...
  components: [
    {
      name: "Meter",
      description: "Graphical meter component for displaying scalar values within a range",
      component: Meter,
    },
  ],
};
