...
export const tablePreviewProps = [
  {
    name: "showBorders",
    type: "boolean",
    description: "Whether to show table borders - adds borders around cells when enabled.",
    defaultValue: true,
  },
  {
    name: "showStripes",
    type: "boolean",
    description: "Whether to show striped rows - alternates row background colors when enabled.",
    defaultValue: false,
  },
  {
    name: "showHeader",
    type: "boolean",
    description: "Whether to show table header - displays column headers when enabled.",
    defaultValue: true,
  },
  {
    name: "showFooter",
    type: "boolean",
    description: "Whether to show table footer - displays footer row when enabled.",
    defaultValue: false,
  },
  {
    name: "size",
    type: "select",
    description: "Table size variant - affects padding and text size throughout the table.",
