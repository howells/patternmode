...
export const /**
              *
              */
  DefaultExample = () => <Button>Click me</Button>;
...
export const /**
              *
              */
  OutlineExample = () => <Button variant="outline">Outline</Button>;

// Ghost variant
export const /**
              *
              */
  GhostExample = () => <Button variant="ghost">Ghost</Button>;

// Link variant
export const /**
              *
              */
  LinkExample = () => <Button variant="link">Link</Button>;
...
export const /**
              *
              */
  LoadingExample = () => <Button isLoading>Loading...</Button>;
...
export const /**
              *
              */
  DisabledExample = () => <Button disabled>Disabled</Button>;
