	...
	examples: [
		{
			id: "basic",
			title: "Basic",
			description: "Basic form label",
			component: BasicExample,
		},
		{
			id: "required",
			title: "Required Field",
			description: "Label for required field with asterisk indicator",
			component: RequiredExample,
		},
		{
			id: "disabled",
			title: "Disabled",
			description: "Disabled label styling for disabled form controls",
			component: DisabledExample,
		},
		{
			id: "custom-styled",
			title: "Custom Styled",
			description: "Label with custom styling and emphasis",
