  ...
  examples: [
    {
      id: "default",
      title: "Default",
      description: "Basic toggle group with icon-only buttons for alignment selection",
      component: DefaultExample,
    },
    {
      id: "multiple-selection",
      title: "Multiple Selection",
      description: "Toggle group supporting multiple selections for text formatting",
    ...
    },
    {
      id: "sizes",
      title: "Sizes",
      description: "Toggle groups in different sizes - small, default, and large",
