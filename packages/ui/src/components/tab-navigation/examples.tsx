...
export const ProfileSectionExample = () => {
  return (
    <TabNavigation className="mb-6">
      <TabNavigationLink href="#general" data-active>
        General
      </TabNavigationLink>
      <TabNavigationLink href="#security">
        Security
      </TabNavigationLink>
      <TabNavigationLink href="#notifications">
        Notifications
      </TabNavigationLink>
      <TabNavigationLink href="#billing">
        Billing
      </TabNavigationLink>
    </TabNavigation>
  );
...
export const ManyTabsExample = () => {
  return (
    <TabNavigation>
      <TabNavigationLink href="#overview" data-active>Overview</TabNavigationLink>
