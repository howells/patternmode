...
export const carouselPreviewProps = [
  {
    name: "slideCount",
    type: "select",
    description: "Number of slides to display - controls how many carousel items are shown.",
    options: [3, 4, 5, 6],
    defaultValue: 3,
  },
  {
    name: "orientation",
    type: "select",
    description: "Carousel orientation - controls whether slides move horizontally or vertically.",
  ...
  },
  {
    name: "loop",
    type: "boolean",
    description: "Whether to enable infinite loop - when true, carousel wraps from last to first slide seamlessly.",
    defaultValue: false,
  },
  {
    name: "showNavigation",
    type: "boolean",
    description: "Whether to show navigation buttons - controls visibility of previous/next arrow buttons.",
    defaultValue: true,
  },
  {
    name: "maxWidth",
    type: "select",
    description: "Maximum width of the carousel container - controls the overall size constraint.",
    options: ["xs", "sm", "md", "lg"],
    defaultValue: "xs",
  },
];
