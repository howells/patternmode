...
export const donutChartPreviewProps = [
  ...
  },
  {
    name: "showLabel",
    type: "boolean",
    description: "Whether to show labels on segments - displays values directly on the chart segments.",
    defaultValue: false,
  },
  {
    name: "showTooltip",
    type: "boolean",
    description: "Whether to show tooltip on hover - provides detailed information on segment interaction.",
    defaultValue: true,
  },
  {
    name: "colors",
    type: "select",
    description: "Color scheme for chart segments - colors are applied to segments in order.",
    options: [
  ...
  },
  {
    name: "variant",
    type: "select",
    description: "Display variant of the donut chart - controls the visual style and information display.",
    options: ["default", "pie"],
