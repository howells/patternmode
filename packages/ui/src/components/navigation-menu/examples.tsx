          ...
          <NavigationMenuContent>
            <div className="grid grid-cols-2 gap-4 p-6 w-96">
              <div>
                ...
                <NavigationMenuLink href="#app1">Application 1</NavigationMenuLink>
                <NavigationMenuLink href="#app2">Application 2</NavigationMenuLink>
              </div>
              <div>
                <h4 className="font-medium mb-2">Hardware</h4>
                <NavigationMenuLink href="#device1">Device 1</NavigationMenuLink>
                <NavigationMenuLink href="#device2">Device 2</NavigationMenuLink>
              </div>
            </div>
          </NavigationMenuContent>
        </NavigationMenuItem>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <div className="p-4 space-y-2 w-64">
              ...
              <NavigationMenuLink href="#contact">Contact Support</NavigationMenuLink>
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <div className="p-4 space-y-2">
              ...
              <NavigationMenuLink href="#product2">Mobile Apps</NavigationMenuLink>
              <NavigationMenuLink href="#product3">Desktop Apps</NavigationMenuLink>
            </div>
          </NavigationMenuContent>
        </NavigationMenuItem>
        <NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuItemLink href="#contact">Contact</NavigationMenuItemLink>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
  );
