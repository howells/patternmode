...
export const collapsiblePreviewProps = [
  {
    name: "defaultOpen",
    type: "boolean",
    description: "Whether the collapsible is open by default when first rendered.",
    defaultValue: true,
  },
  {
    name: "disabled",
    type: "boolean",
    description: "Whether the collapsible trigger is disabled and cannot be toggled.",
    defaultValue: false,
  },
];
