...
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@patternmode/ui";
import { ChevronDown, ChevronRight, HelpCircle, Info, Settings } from "lucide-react";
          ...
          <Collapsible>
            ...
            <CollapsibleContent>
              <p className="ml-4">This is nested content 2.</p>
                   ...
                   *
                   */
  CollapsibleExample = DefaultExample;
