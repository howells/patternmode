	...
	components: [
		{
			name: "Toolbar",
			description:
				"Root container for toolbar items with coordinated layout and styling.",
			component: Toolbar,
			primary: true,
		},
		{
			name: "Toolbar Button",
			description:
				"Interactive button component for toolbar actions with hover and pressed states.",
			component: ToolbarButton,
		},
		{
			name: "Toolbar Group",
			description:
				"Group component for organizing related toolbar items with consistent spacing.",
			component: ToolbarGroup,
		},
		{
			name: "Toolbar Input",
			description:
				"Input component for toolbar search and data entry with integrated styling.",
			component: ToolbarInput,
		},
		{
			name: "Toolbar Link",
			description:
				"Link component for toolbar navigation actions with proper focus management.",
			component: ToolbarLink,
		},
		{
			name: "Toolbar Separator",
			description:
				"Visual separator for dividing toolbar sections and improving organization.",
