  ...
  const [faqs, setFaqs] = React.useState([
    {
      ...
      answer: "FieldArray is a generic component for managing dynamic lists of structured data with configurable field schemas.",
    },
    {
      question: "How do I customize field types?",
      answer: "Use the componentMap prop to provide custom components for different field types, or extend the default component map.",
    },
  ]);
            ...
            <Fieldset>
              <HStack justify="between" align="center">
                <HStack gap={3} align="center">
                  ...
                  />
                  <VStack gap={1}>
                    <div className="font-medium text-sm">{item.name || "Unnamed Member"}</div>
                      ...
                      {field.type === "select"
                        ? (
                            <Select
                              ...
                              onValueChange={value => updateItem({ [field.key]: value })}
                            >
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                        ...
                        : (
                            <Input
                              value={item[field.key] || ""}
                              onChange={e => updateItem({ [field.key]: e.target.value })}
