...
export const sheetConfig: ComponentConfig = {
	...
	components: [
		...
		},
		{
			name: "Sheet Content",
			description:
				"Main container that slides in from the right with backdrop overlay.",
			component: SheetContent,
		},
		{
			name: "Sheet Header",
			description:
				"Header section with title, description, and automatic close button.",
		...
		},
		{
			...
			description:
				"Explanatory text providing context about the sheet's purpose.",
