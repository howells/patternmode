        ...
        return (
          <div className="py-4">
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
              This is a simple sheet with basic content. Perfect for displaying supplementary information.
            </p>
            <div className="space-y-2">
              <div className="p-3 bg-zinc-50 dark:bg-zinc-900 rounded-md">
                <p className="text-sm font-medium">Note</p>
                <p className="text-xs text-zinc-500">Additional information goes here</p>
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="py-4">
            <nav className="space-y-1">
              <a href="#" className="block px-3 py-2 text-sm rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800">
                Dashboard
              </a>
              <a href="#" className="block px-3 py-2 text-sm rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800">
                Projects
      ...
      case "settings":
        return (
          <div className="py-4 space-y-6">
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-3">Profile Settings</h3>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-3">Preferences</h3>
...
export const sheetPreviewProps = [
  {
    name: "side",
    type: "select",
    description: "Sheet opening direction - controls which side of the screen the sheet slides in from.",
  ...
  },
  {
    name: "contentLevel",
    type: "select",
    description: "Content complexity level - determines how much content is displayed in the sheet.",
