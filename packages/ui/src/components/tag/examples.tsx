...
export const EXAMPLES: ComponentExample[] = [
  ...
  {
    id: "WithCountsExample",
    title: "With Counts",
    description: "With Counts example",
    component: WithCountsExample,
  },
  {
    id: "DismissibleExample",
    title: "Dismissible",
    description: "Dismissible example",
    component: DismissibleExample,
  },
  {
    id: "WithAvatarsExample",
    title: "With Avatars",
    description: "With Avatars example",
