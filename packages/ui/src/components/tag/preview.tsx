...
export const tagPreviewProps = [
	{
		...
		type: "string",
		description:
			"The value text (e.g., 'Sales', 'Zurich'). The primary content of the tag.",
		defaultValue: "Sales",
	},
	{
		name: "label",
		type: "string",
		description:
			"The label text (e.g., 'Department', 'Location'). Displays as a subtle prefix.",
	...
	},
	{
		...
		type: "boolean",
		description:
			"Whether the tag can be dismissed. Shows a dismiss button when true.",
		defaultValue: false,
	},
];
