...
export const lineChartConfig: ComponentConfig = {
	...
	name: "Line Chart",
	description:
		"A comprehensive line chart component built on Recharts for displaying time series data, trends, and multi-category comparisons. Features interactive legends, tooltips, and extensive customization options.",
	category: "charts",
	icon: TrendingUp,
	...
	components: [
		{
			name: "Line Chart",
			description:
				"Interactive line chart component for time series data visualization",
			component: LineChart,
		},
	],
};
