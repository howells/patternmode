...
export function SidebarGroup({
	...
	return (
		<LayoutGroup id={id}>
			<div {...props} data-component="SidebarGroup" className={cx(className)}>
				{heading && (
					<div
						className={cx(
							"flex items-center justify-between px-4",
							sticky &&
								"sticky bg-zinc-100/90 dark:bg-zinc-900/90 backdrop-blur-sm border-b border-zinc-950/5 dark:border-white/5",
...
export const SidebarItem = function SidebarItem({
	...
	const buttonElement = (
		<Button
			render={render || (href ? (props) => <a href={href} {...props} /> : undefined)}
			variant="minimal"
			icon={icon}
			leftIcon={LeftIcon}
			rightIcon={href ? ArrowRight : undefined}
