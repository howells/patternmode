...
export const sidebarPreviewProps = [
	{
		...
		type: "select",
		description:
			"Sidebar display variant - controls the visual style and behavior of the sidebar.",
	...
	},
	{
		...
		type: "select",
		description:
			"Sidebar position - controls which side of the screen the sidebar appears on.",
		options: ["left", "right"],
		defaultValue: "left",
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show the sidebar header - displays title and close button when enabled.",
		defaultValue: true,
	},
	{
		name: "showFooter",
		type: "boolean",
		description:
			"Whether to show the sidebar footer - displays additional actions at the bottom when enabled.",
		defaultValue: false,
	},
	{
		name: "contentType",
		type: "select",
		description:
			"Type of content to display - controls the structure and examples shown in the sidebar.",
