...
export const stackPreviewProps = [
  {
    name: "direction",
    type: "select",
    description: "The direction of the stack - controls whether children are arranged vertically or horizontally.",
  ...
  },
  {
    name: "wrap",
    type: "boolean",
    description: "Whether items should wrap to new lines when space is limited.",
    defaultValue: false,
  },
  {
    name: "padding",
