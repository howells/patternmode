...
export const /**
  ...
  // Convert string gap/padding to numbers for the component
    const gapValue = typeof gap === "string" ? Number.parseInt(gap, 10) : gap;
    const paddingValue
    = typeof padding === "string" ? Number.parseInt(padding, 10) : padding;
      ...
      return (
        <div className="space-y-6">
          <div className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
            <strong>Responsive Example:</strong>
            {" "}
            This stack changes direction and
          ...
          <div className="text-xs text-zinc-500 dark:text-zinc-400 space-y-1">
            <div>
              <strong>sm:</strong>
              {" "}
              direction=&quot;vertical&quot;, gap=2 (8px)
            </div>
            <div>
              <strong>md:</strong>
              {" "}
              direction=&quot;vertical&quot;, gap=4 (16px)
            </div>
            <div>
              <strong>lg:</strong>
              {" "}
              direction=&quot;horizontal&quot;, gap=6 (24px)
            </div>
          </div>
        </div>
      );
