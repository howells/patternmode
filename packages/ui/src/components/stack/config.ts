...
export const stackConfig: ComponentConfig = {
	id: "stack",
	name: "Stack",
	description:
		"Flexible layout components for arranging content in vertical or horizontal stacks with consistent spacing, alignment, and responsive behavior.",
	category: "layout",
	featured: true,
	icon: Layout,
