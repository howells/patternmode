...
export const barChartPreviewProps = [
	{
		...
		type: "select",
		description:
			"Chart orientation layout - controls whether bars are vertical or horizontal.",
	...
	},
	{
		...
		type: "select",
		description:
			"Chart stacking type - controls how multiple series are displayed.",
	...
	},
	{
		...
		type: "select",
		description:
			"Color scheme for chart series - colors are applied to categories in order.",
		options: [
