 ...
 */
const PopoverPositioner = ({ ref, sideOffset = 10, collisionPadding = 5, ...props }: PopoverPositionerProps) => (
...
const PopoverContent = (
  { ref, className, sideOffset = 10, side = "bottom", align = "center", collisionPadding = 5, ...props }: PopoverContentProps,
) => {
  return (
    <PopoverPortal>
      <PopoverPositioner
