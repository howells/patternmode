...
export const checkboxConfig: ComponentConfig = {
  ...
  examples: [
    {
      id: "default",
      title: "Default",
      description: "Basic unchecked checkbox",
      component: DefaultExample,
    },
    {
      id: "checked",
      title: "Checked",
      description: "Pre-checked checkbox state",
      component: CheckedExample,
    },
    {
      id: "indeterminate",
      title: "Indeterminate",
      description: "Partially checked state for parent checkboxes",
      component: IndeterminateExample,
    },
    {
      id: "disabled",
      title: "Disabled",
      description: "Disabled checkboxes in various states",
      component: DisabledExample,
    },
    {
      id: "with-label",
      title: "With Label",
      description: "Checkbox with associated text label",
      component: WithLabelExample,
    },
    {
      id: "controlled",
      title: "Controlled",
      description: "Controlled checkbox with state management",
  ...
  components: [
    {
      name: "Checkbox",
      description: "Checkbox input for boolean selections with indeterminate state support",
      component: Checkbox,
    },
  ],
};
