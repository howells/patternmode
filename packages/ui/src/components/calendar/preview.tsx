...
export const calendarPreviewProps = [
  {
    ...
    type: "boolean",
    description: "Show year navigation buttons that allow jumping forward and backward by year.",
    defaultValue: false,
  },
  {
    name: "showToday",
  ...
  },
  {
    name: "mode",
    type: "select",
    description: "Selection mode for the calendar - controls whether single dates, multiple dates, or date ranges can be selected.",
  ...
  },
  {
    name: "numberOfMonths",
    type: "select",
    description: "Number of months to display at once - shows multiple months side by side when greater than 1.",
    options: [1, 2, 3],
    defaultValue: 1,
  },
];
