...
import { DefaultExample, TablePaginationExample, WithGapsExample } from "./examples";

export const paginationConfig: ComponentConfig = {
  id: "pagination",
  name: "Pagination",
  description: "A comprehensive pagination system for navigating through large datasets. Built with Next.js Link integration for client-side routing and proper accessibility support for screen readers.",
  category: "navigation",
  icon: ChevronLeft,
