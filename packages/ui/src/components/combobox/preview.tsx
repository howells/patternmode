...
export const comboboxPreviewProps = [
	{
		...
		type: "select",
		description:
			"Data type for the combobox options - controls what kind of data is displayed in the dropdown.",
	...
	},
	{
		...
		type: "select",
		description:
			"Number of options to display - controls how many choices are available in the dropdown.",
		options: [5, 8, 12, 20],
		defaultValue: 5,
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show option descriptions - displays additional information for each option.",
		defaultValue: false,
	},
	{
		name: "size",
		type: "select",
		description:
			"Combobox size variant - controls the overall size and padding of the input.",
		options: ["sm", "base", "lg"],
		defaultValue: "base",
	},
	{
		...
		type: "string",
		description:
			"Default selected value - pre-selects an option when the component loads.",
		defaultValue: "",
	},
];
