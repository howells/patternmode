...
export const comboboxConfig: ComponentConfig = {
	...
	name: "Combobox",
	description:
		"Searchable dropdown component combining input and select functionality. Built on Downshift for accessibility and React Query for data management, supporting both static options and dynamic server-side filtering with infinite scroll.",
	category: "controls",
	icon: ChevronsUpDown,
