...
export const iconSelectConfig: ComponentConfig = {
	...
	name: "Icon Select",
	description:
		"A high-performance, tree-shakable searchable icon picker component that provides access to ALL 1,700+ Lucide React icons using a static registry and virtual scrolling. Icons are loaded instantly with no async operations, ensuring optimal performance and reliability.",
	category: "controls",
	icon: Search,
	...
	examples: [
		...
		},
		{
			...
			description:
				"Rendering icons dynamically using getDynamicIconByName utility",
	...
	components: [
		{
			name: "Icon Select",
			description:
				"Searchable icon picker with virtual scrolling for 1700+ Lucide icons.",
