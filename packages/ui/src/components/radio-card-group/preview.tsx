...
export const radioCardGroupPreviewProps = [
	{
		...
		type: "select",
		description:
			"Card layout arrangement - controls how cards are arranged in the group.",
		options: ["grid", "stack"],
		defaultValue: "grid",
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show pricing information - displays price details when enabled.",
		defaultValue: true,
	},
	{
		name: "showFeatures",
		type: "boolean",
		description:
			"Whether to show feature lists - displays feature details when enabled.",
		defaultValue: true,
	},
	{
		name: "showIcons",
		type: "boolean",
		description:
			"Whether to show icons - displays icon indicators when enabled.",
		defaultValue: true,
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show popular badge - highlights recommended options when enabled.",
		defaultValue: true,
	},
];
