...
type RadioCardGroupProps = React.ComponentPropsWithoutRef<typeof BaseRadioGroup> & {
...
type RadioCardIndicatorProps = React.ComponentPropsWithoutRef<typeof Radio.Indicator> & {
 ...
 */
const RadioCardItem = ({ ref, className, children, ...props }: RadioCardItemProps) => (
  <Radio.Root
    ref={ref}
    className={cx(
      // base
 ...
 */
const RadioCardIndicator = ({ ref, className, ...props }: RadioCardIndicatorProps) => (
  <Radio.Indicator
    ref={ref}
    className={cx(
      // base
...
export type { RadioCardGroupProps, RadioCardIndicatorProps, RadioCardItemProps };
