    ...
    <div className="space-y-4">
      ...
      {selectedBar && (
        <div className="p-3 bg-zinc-50 dark:bg-zinc-900 rounded-md">
          <p className="text-sm">
            <span className="font-medium">{selectedBar.name}</span>
            {" "}
            - Category:
            {" "}
...
export const EXAMPLES: ComponentExample[] = [
  ...
  {
    id: "WithFormatterExample",
    title: "With Formatter",
    description: "With Formatter example",
  ...
  },
  {
    id: "WithLinksExample",
    title: "With Links",
    description: "With Links example",
  ...
  },
  {
    id: "AscendingExample",
    title: "Ascending",
    description: "Ascending example",
    component: AscendingExample,
  },
  {
    id: "PerformanceExample",
    title: "Performance Optimization",
    description: "Performance optimized example",
    component: PerformanceExample,
  },
  {
    id: "SalesByRegionExample",
    title: "Sales By Region",
    description: "Sales By Region example",
  ...
  },
  {
    id: "NoSortingExample",
    title: "No Sorting",
    description: "No Sorting example",
    component: NoSortingExample,
  },
  {
    id: "ComplexDataExample",
    title: "Complex Data",
    description: "Complex Data example",
    component: ComplexDataExample,
  },
  {
    id: "WebsiteAnalyticsExample",
    title: "Website Analytics",
    description: "Website Analytics example",
