...
export const barListPreviewProps = [
	{
		...
		type: "boolean",
		description:
			"Whether to animate bar width transitions - creates smooth transitions when data changes.",
		defaultValue: true,
	},
	{
		name: "color",
		type: "select",
		description:
			"Color scheme for the bars - when set to 'auto', uses colors from data objects.",
	...
	},
	{
		...
		type: "select",
		description:
			"Whether to sort bars by value - when set, displays bars in specified order.",
