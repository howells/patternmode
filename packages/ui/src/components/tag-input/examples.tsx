...
import { Icon, iconRegistry, Tag, TagInput, useTagInput } from "@patternmode/ui";

import React from "react";
// Pre-imported icons from registry
const { Code, MapPin, Palette, User } = iconRegistry;
...
export const BlogPostTagsExample = () => {
...
export const EXAMPLES: ComponentExample[] = [
  ...
  {
    id: "WithInitialValuesExample",
    title: "With Initial Values",
    description: "Example with pre-set initial values",
    component: WithInitialValuesExample,
  },
  {
    id: "WithMaxTagsExample",
    title: "With Max Tags",
    description: "With Max Tags example",
    component: WithMaxTagsExample,
  },
  {
    id: "WithTagCreationExample",
    title: "With Tag Creation",
    description: "With Tag Creation example",
    component: WithTagCreationExample,
  },
  {
    id: "CustomTagRenderingExample",
    title: "Custom Tag Rendering",
    description: "Custom Tag Rendering example",
  ...
  {
    id: "BlogPostTagsExample",
    title: "Blog Post Tags",
    description: "Blog Post Tags example",
    component: BlogPostTagsExample,
  },
];
