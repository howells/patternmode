...
export const trackerConfig: ComponentConfig = {
	id: "tracker",
	name: "Tracker",
	description:
		"Visual progress tracker component for displaying steps, stages, or progress through a process using colored blocks. Each block can have custom colors, tooltips, and hover effects to provide detailed information about different stages.",
	category: "visual",
	icon: Target,
	...
	components: [
		{
			name: "Tracker",
			description:
				"Visual progress indicator using colored blocks with optional tooltips and hover effects.",
			component: Tracker,
			primary: true,
		},
	],
