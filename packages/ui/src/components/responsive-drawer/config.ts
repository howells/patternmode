...
export const responsiveDrawerConfig: ComponentConfig = {
  ...
  description: "Responsive drawer component that adapts behavior based on screen size. On mobile devices, it renders as a bottom drawer using Vaul library. On desktop, it displays as a side sheet using Base UI Dialog. Provides consistent API across both implementations.",
  category: "overlay",
  icon: PanelLeft,
