    ...
    <MenuBar className="mb-4">
      <MenuBarMenu>
        ...
        <MenuBarContent>
          ...
          <MenuBarItem onSelect={() => handleAction("saveAs")}>Save As...</MenuBarItem>
          <MenuBarSeparator />
      ...
      <MenuBarMenu>
        ...
        <MenuBarContent>
          ...
          <MenuBarItem onSelect={() => handleAction("extensions")}>Extensions</MenuBarItem>
          <MenuBarSeparator />
          <MenuBarItem onSelect={() => handleAction("command")}>Command Palette</MenuBarItem>
        </MenuBarContent>
      </MenuBarMenu>
      ...
      <MenuBarMenu>
        ...
        <MenuBarContent>
          ...
          <MenuBarItem onSelect={() => handleAction("support")}>Support</MenuBarItem>
          <MenuBarSeparator />
          <MenuBarItem onSelect={() => handleAction("about")}>About</MenuBarItem>
        </MenuBarContent>
      </MenuBarMenu>
    </MenuBar>
  );
