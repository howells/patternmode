...
export const comboChartPreviewProps = [
	{
		...
		type: "boolean",
		description:
			"Whether to show grid lines - helps with value reading but can add visual noise.",
		defaultValue: true,
	},
	{
		name: "showLegend",
	...
	},
	{
		...
		type: "boolean",
		description:
			"Whether to show tooltip on hover - provides detailed information on data point interaction.",
		defaultValue: true,
	},
	{
		name: "barColors",
		type: "select",
		description:
			"Bar series color scheme - colors applied to bar categories in order.",
		options: [
	...
	},
	{
		...
		type: "select",
		description:
			"Line series color scheme - colors applied to line categories in order.",
		options: [
			{ label: "Emerald", value: ["emerald"] },
			{ label: "Blue", value: ["blue"] },
			{ label: "Pink", value: ["pink"] },
