...
export const comboChartConfig: ComponentConfig = {
	...
	name: "Combo Chart",
	description:
		"Combination chart supporting multiple chart types in a single visualization. Built on Recharts with support for bar and line series, biaxial charts, interactive legends, and extensive customization options.",
	category: "charts",
	icon: BarChart3,
