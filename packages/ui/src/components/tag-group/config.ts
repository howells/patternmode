	...
	examples: [
		{
			id: "default",
			title: "Default",
			description: "Basic tag group with default styling",
			component: DefaultExample,
		},
		{
			id: "dismissible",
			title: "Dismissible Tags",
			description: "Tags that can be removed from the group",
		...
		},
		{
			...
			description: "Row vs column layout direction",
			component: DirectionExample,
		},
		{
			id: "custom-gap",
			title: "Custom Spacing",
			description: "Custom gap between tags",
		...
		},
		{
			...
			component: LabeledTagsExample,
		},
		{
			id: "tags-with-count",
			title: "Tags with Counts",
			description: "Tags displaying count or quantity",
			component: TagsWithCountExample,
		},
		{
			id: "mixed-override",
			title: "Mixed Overrides",
			description: "Individual tags can override group properties",
			component: MixedOverrideExample,
		},
	],
	components: [
		{
			name: "Tag Group",
			description:
				"Container for grouping tags with shared props and consistent spacing",
			component: TagGroup,
			primary: true,
		},
	],
