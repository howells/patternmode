...
const SparkChart = ({
	ref: forwardedRef,
	...props
}: SparkChartProps & { ref?: React.RefObject<HTMLDivElement | null> }) => {
	const {
		variant = "bar",
...
const SparkAreaChart = (
	props: SparkAreaChartProps & { ref?: React.RefObject<HTMLDivElement | null> },
) => <SparkChart {...props} variant="area" />;

SparkAreaChart.displayName = "SparkAreaChart";

type SparkLineChartProps = Omit<
	SparkChartProps,
	"variant" | "fill" | "barCategoryGap" | "type"
> & {
	connectNulls?: SparkChartProps["connectNulls"];
};
...
const SparkLineChart = (
	props: SparkLineChartProps & { ref?: React.RefObject<HTMLDivElement | null> },
) => <SparkChart {...props} variant="line" />;

SparkLineChart.displayName = "SparkLineChart";

type SparkBarChartProps = Omit<
	SparkChartProps,
	"variant" | "fill" | "connectNulls"
> & {
 ...
 */
const SparkBarChart = (
	props: SparkBarChartProps & { ref?: React.RefObject<HTMLDivElement | null> },
