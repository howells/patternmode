...
}; export const ComboChartExample = DefaultExample;
...
export const EXAMPLES: ComponentExample[] = [
  ...
  },
  {
    id: "BiaxialExample",
    title: "Biaxial",
    description: "Biaxial example",
    component: BiaxialExample,
  },
  {
    id: "StackedBarsExample",
    title: "Stacked Bars",
    description: "Stacked Bars example",
  ...
  {
    id: "ComboChartExample",
    title: "Combo Chart",
    description: "Combo Chart example",
