 ...
 * Table Components.
 *
 * Comprehensive table components for displaying tabular data with professional styling
 * and responsive behavior. Built with semantic HTML elements and accessibility in mind,
 * providing all necessary table elements from root container to individual cells.
 *
 * Features:
 * - Responsive horizontal scrolling on mobile
 * - Clean, professional Tremor-inspired design
 * - Dark mode support throughout
 * - Semantic HTML table structure
 * - Consistent spacing and typography
 * - Border styling with proper contrast
 * - Caption support for accessibility
 * - Footer section for summaries and totals.
 *
 * @category data
 * @icon Table
 * @example
