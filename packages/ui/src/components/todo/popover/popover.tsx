 ...
 * and proper focus management. Perfect for tooltips, menus, content overlays,
 * and rich contextual information panels.
 *
 * @component
 * @category ui
 * @icon MessageSquare
 ...
 */
/**
 * Floating content container positioned relative to trigger elements.
 *
 * @id popover
 * @name Popover
 * @icon MessageSquare
