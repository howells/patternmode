 ...
 * @category charts
 * @component
 * @see {@link https://recharts.org/en-US/api/PieChart}
 ...
 * @see {@link https://recharts.org/en-US/api/PieChart}
 * @param props - Component properties.
 * @param props.data - Array of data objects for chart rendering.
 * @param props.category - Key name for category field in data.
 * @param props.value - Key name for value field in data.
 * @param props.colors - Color themes for chart segments.
 * @param props.variant - Chart variant (donut with center hole or solid pie).
 * @param props.valueFormatter - Function to format values for display.
 * @param props.label - Custom label text for center display.
 * @param props.showLabel - Whether to show center label (donut variant only).
 * @param props.showTooltip - Whether to show tooltips on hover.
 * @param props.onValueChange - Callback for chart click interactions.
 * @param props.tooltipCallback - Callback for tooltip events.
