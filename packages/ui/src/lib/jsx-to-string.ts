...
type PropValue = string | number | boolean | null | undefined | IconComponent | React.ReactElement | unknown[] | Record<string, unknown>;
type Props = Record<string, PropValue> & { children?: React.ReactNode };
...
export function jsxToString(
  ...
  // Format props
  const propsString = formatProps(props as Props);
 ...
 */
function getFunctionName(func: IconComponent): string {
