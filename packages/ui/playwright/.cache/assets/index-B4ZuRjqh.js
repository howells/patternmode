...
function requireClient () {
	...
	if (false) {
	  ...
	  client$2.exports = requireReactDomClient_development();
	}
...
define_process_env_default.NODE_ENV = "test";
...
const __pwRootRegistry = /* @__PURE__ */ new Map();
...
window.playwrightMount = async (component, rootElement, hooksConfig) => {
  ...
  const entry = { root, setRenderer: () => void 0 };
...
const _Users_danielhowells_Sites_patternmode_packages_ui_src_components_tag_input_preview_TagInputExample = () => __vitePreload(() => import('./preview-Cs9RGsmQ.js'),true              ?[]:void 0).then((mod) => mod.TagInputExample);
__pwRegistry.initialize({ _Users_danielhowells_Sites_patternmode_packages_ui_src_components_tag_input_preview_TagInputExample });

export { React as R, __vitePreload as _, reactExports as a, React$1 as b, getDefaultExportFromCjs as g, requireReact as r };
//# sourceMappingURL=index-B4ZuRjqh.js.map
