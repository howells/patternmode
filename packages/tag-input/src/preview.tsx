...
export const tagInputPreviewProps = [
  { name: "allowCreate", type: "boolean", description: "Allow creating custom tags", defaultValue: true },
  { name: "maxTags", type: "number", description: "Max selectable tags", defaultValue: 5, min: 1, max: 20 },
  { name: "minTags", type: "number", description: "Min required tags", defaultValue: 0, min: 0, max: 10 },
  { name: "showDescriptions", type: "boolean", description: "Show descriptions in labels", defaultValue: false },
  { name: "placeholder", type: "string", description: "Empty input placeholder", defaultValue: "Select tags..." },
  { name: "selectedPlaceholder", type: "string", description: "Placeholder once some selected", defaultValue: "Add more tags..." },
  { name: "emptyMessage", type: "string", description: "No options message", defaultValue: "No options found." },
  { name: "disabled", type: "boolean", description: "Disable interaction", defaultValue: false },
  { name: "wrap", type: "boolean", description: "Wrap selected tags", defaultValue: true },
  { name: "maxHeight", type: "number", description: "Dropdown max height", defaultValue: 200, min: 120, max: 480 },
];
