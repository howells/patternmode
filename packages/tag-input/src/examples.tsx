  ...
  return (
    <TagInput
      ...
      renderItem={(option, isHighlighted, isSelected) => (
        <div
          className={`flex items-center gap-3 p-2 ${isHighlighted ? "bg-zinc-100 dark:bg-zinc-800" : ""} ${isSelected ? "font-medium" : ""}`}
        >
...
export const ComplexExample = () => {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <div className="font-medium text-sm">Preferred Locations</div>
        <TagInput
          allowCreate
          className="max-w-md"
          maxTags={4}
