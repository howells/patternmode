...
export const calloutVariants = tv({
	...
	variants: {
		variant: {
			...
			warning:
				"bg-yellow-50 border-yellow-200 text-yellow-900 dark:bg-yellow-950/40 dark:border-yellow-900 dark:text-yellow-100",
			neutral:
				"bg-zinc-50 border-zinc-200 text-zinc-900 dark:bg-zinc-950/40 dark:border-zinc-900 dark:text-zinc-100",
		},
	},
});
