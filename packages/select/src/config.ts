...
export const selectConfig: ComponentConfig = {
  ...
  examples: [
    ...
    },
    {
      id: "with-groups",
      title: "With Groups",
      description: "Organize options in groups",
    ...
    },
    {
      id: "small",
      title: "Small Size",
      description: "Compact trigger",
      component: SmallSizeExample,
    },
    {
      id: "form",
      title: "Form Integration",
      description: "Usage in forms",
