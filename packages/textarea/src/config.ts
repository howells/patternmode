...
export const textareaConfig: ComponentConfig = {
  ...
  examples: [
    ...
    { id: "with-error", title: "With Error", description: "Textarea in error state", component: WithErrorExample },
    { id: "with-row-constraints", title: "Row Constraints", description: "Textarea with minimum and maximum row limits", component: WithRowConstraintsExample },
    { id: "disabled", title: "Disabled", description: "Textarea in disabled state", component: DisabledExample },
    { id: "fixed-height", title: "Fixed Height", description: "Textarea with fixed height and scrolling", component: FixedHeightExample },
    { id: "with-height-callback", title: "Height Tracking", description: "Textarea with height change monitoring", component: WithHeightCallbackExample },
  ],
  components: [
