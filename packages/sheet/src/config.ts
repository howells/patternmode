...
export const sheetConfig: ComponentConfig = {
  ...
  examples: [
    {
      id: "default",
      title: "Default",
      description: "Basic sheet with open/close controls",
      component: DefaultExample,
    },
    {
      id: "settings",
      title: "Settings",
      description: "Form-style panel for user preferences",
      component: SettingsExample,
    },
    {
      id: "information",
      title: "Information",
      description: "Read-only info panel with details",
      component: InformationExample,
    },
    {
      id: "contact-form",
      title: "Contact Form",
      description: "Side panel with contact form fields",
  ...
  components: [
    {
      name: "Sheet",
      description: "Root sheet container",
      component: Sheet,
      primary: true,
    },
    {
    ...
    {
      name: "SheetContent",
      description: "Sheet content container",
      component: SheetContent,
    },
    {
      name: "SheetHeader",
      description: "Sheet header area",
    ...
    {
      name: "SheetFooter",
      description: "Footer with actions",
      component: SheetFooter,
    },
    {
      name: "SheetClose",
      description: "Close button for the sheet",
