 ...
 * - All 1822+ Lucide React icons as a static object
 * - Type-safe icon access
 * - Zero runtime analysis or filtering
 * - Optimal performance with tree-shaking
 */
// biome-ignore lint/performance/noNamespaceImport: Generated registry requires a namespace import for full icon map
