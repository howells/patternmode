...
export function ToggleGroupPreview({
  ...
  return (
    <ToggleGroup defaultValue={defaultValue} variant={variant} size={size} disabled={false}>
      {items.map((item) => {
...
export const toggleGroupPreviewProps = [
  {
    ...
    type: "select",
    description:
      "Toggle group selection type - controls whether single or multiple items can be selected.",
  ...
  },
  {
    ...
    type: "select",
    description:
      "Toggle group style variant - controls the visual appearance of the toggle items.",
  ...
  },
  {
    ...
    type: "select",
    description:
      "Toggle group orientation - controls whether items are arranged horizontally or vertically.",
  ...
  },
  {
    ...
    type: "boolean",
    description:
      "Whether to show icons in toggle items - displays icons alongside text when enabled.",
    defaultValue: true,
  },
];
