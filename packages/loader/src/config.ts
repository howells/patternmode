...
export const loaderConfig: ComponentConfig = {
	...
	name: "Loader",
	description:
		"A spinning loader component for indicating loading states and async operations. Built with Lucide React's Loader2 icon and tailwind-variants for consistent sizing and styling across different contexts.",
	category: "feedback",
	featured: true,
	icon: Loader2,
	...
	examples: [
		...
		},
		{
			...
			title: "Centered",
			description:
				"Centered loader with accompanying text for full-page loading states",
