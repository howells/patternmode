...
export const comboboxPreviewProps = [
  { name: "dataType", type: "select", options: ["frameworks", "languages", "countries", "colors"], defaultValue: "frameworks" },
  { name: "optionCount", type: "select", options: [5, 8, 12, 20], defaultValue: 8 },
  { name: "showDescriptions", type: "boolean", defaultValue: true },
  { name: "size", type: "select", options: ["2xs", "xs", "sm", "base", "lg"], defaultValue: "base" },
