...
export const menuConfig: ComponentConfig = {
  ...
  featured: true,
  icon: MoreVertical,
  importStatement: `import { Menu, MenuTrigger, MenuContent, MenuItem, MenuCheckboxItem, MenuRadioGroup, MenuRadioItem, MenuLabel, MenuSeparator, MenuSubmenu, MenuSubmenuTrigger, MenuSubmenuContent, MenuGroup } from "@patternmode/menu";`,
  examples: [
    {
      id: "default",
      title: "Default",
    ...
    },
    {
      ...
      title: "Complex Menu",
      description:
        "Advanced menu combining all features with proper organization",
  ...
  components: [
    ...
    {
      name: "Menu Submenu Trigger",
      component: MenuSubmenuTrigger,
      description:
        "Trigger element for opening submenu with chevron indicator.",
    },
    {
      name: "Menu Submenu Content",
