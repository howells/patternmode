...
describe('CopyButton Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'copy-button')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'copy-button.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'copy-button.tsx')
