...
describe('LineChart Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'line-chart')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'line-chart.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'line-chart.tsx')
