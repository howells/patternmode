...
describe('Navbar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'navbar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'navbar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'navbar.tsx')
