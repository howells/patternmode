...
describe('Toggle Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'toggle')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'toggle.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'toggle.tsx')
