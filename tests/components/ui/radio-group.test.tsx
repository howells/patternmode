...
describe('RadioGroup Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'radio-group')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'radio-group.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'radio-group.tsx')
