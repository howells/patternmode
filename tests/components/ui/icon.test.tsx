...
describe('Icon Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'icon')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'icon.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'icon.tsx')
