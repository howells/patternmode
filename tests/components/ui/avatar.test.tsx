...
describe('Avatar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'avatar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'avatar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'avatar.tsx')
