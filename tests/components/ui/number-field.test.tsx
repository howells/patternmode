...
describe('NumberField Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'number-field')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'number-field.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'number-field.tsx')
