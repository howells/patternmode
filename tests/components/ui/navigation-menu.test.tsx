...
describe('NavigationMenu Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'navigation-menu')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'navigation-menu.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'navigation-menu.tsx')
