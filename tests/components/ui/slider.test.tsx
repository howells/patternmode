...
describe('Slider Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'slider')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'slider.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'slider.tsx')
