...
describe('RadioCardGroup Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'radio-card-group')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'radio-card-group.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'radio-card-group.tsx')
