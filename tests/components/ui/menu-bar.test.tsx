...
describe('MenuBar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'menu-bar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'menu-bar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'menu-bar.tsx')
