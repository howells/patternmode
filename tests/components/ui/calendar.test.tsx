...
describe('Calendar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'calendar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'calendar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'calendar.tsx')
