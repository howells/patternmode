...
describe('Accordion Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'accordion')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'accordion.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'accordion.tsx')
