...
describe('DescriptionList Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'description-list')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'description-list.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'description-list.tsx')
