...
describe('Toast Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'toast')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'toast.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'toast.tsx')
