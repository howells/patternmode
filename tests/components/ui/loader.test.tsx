...
describe('Loader Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'loader')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'loader.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'loader.tsx')
