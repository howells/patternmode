...
describe('ProgressCircle Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'progress-circle')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'progress-circle.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'progress-circle.tsx')
