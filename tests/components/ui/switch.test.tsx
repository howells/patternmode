...
describe('Switch Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'switch')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'switch.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'switch.tsx')
