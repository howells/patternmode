...
describe('DismissButton Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'dismiss-button')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'dismiss-button.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'dismiss-button.tsx')
