...
describe('TabNavigation Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'tab-navigation')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'tab-navigation.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'tab-navigation.tsx')
