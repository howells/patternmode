...
describe('Card Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'card')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'card.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'card.tsx')
