...
describe('Subheading Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'subheading')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'subheading.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'subheading.tsx')
