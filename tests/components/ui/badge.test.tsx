...
describe('Badge Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'badge')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'badge.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'badge.tsx')
