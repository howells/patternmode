...
describe('Field Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'field')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'field.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'field.tsx')
