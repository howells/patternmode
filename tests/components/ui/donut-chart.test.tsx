...
describe('DonutChart Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'donut-chart')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'donut-chart.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'donut-chart.tsx')
