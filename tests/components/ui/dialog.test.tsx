...
describe('Dialog Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'dialog')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'dialog.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'dialog.tsx')
