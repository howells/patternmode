...
describe('IconSelect Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'icon-select')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'icon-select.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'icon-select.tsx')
