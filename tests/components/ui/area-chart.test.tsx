...
describe('AreaChart Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'area-chart')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'area-chart.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'area-chart.tsx')
