...
describe('AlertDialog Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'alert-dialog')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'alert-dialog.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'alert-dialog.tsx')
