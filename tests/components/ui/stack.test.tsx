...
describe('Stack Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'stack')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'stack.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'stack.tsx')
