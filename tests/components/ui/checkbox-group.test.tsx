...
describe('CheckboxGroup Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'checkbox-group')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'checkbox-group.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'checkbox-group.tsx')
