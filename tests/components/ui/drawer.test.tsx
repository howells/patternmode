...
describe('Drawer Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'drawer')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'drawer.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'drawer.tsx')
