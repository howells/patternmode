...
describe('Divider Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'divider')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'divider.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'divider.tsx')
