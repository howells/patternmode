...
describe('Heading Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'heading')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'heading.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'heading.tsx')
