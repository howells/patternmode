...
describe('PreviewCard Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'preview-card')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'preview-card.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'preview-card.tsx')
