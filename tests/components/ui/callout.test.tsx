...
describe('Callout Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'callout')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'callout.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'callout.tsx')
