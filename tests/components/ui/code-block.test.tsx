...
describe('CodeBlock Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'code-block')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'code-block.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'code-block.tsx')
