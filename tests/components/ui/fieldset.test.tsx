...
describe('Fieldset Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'fieldset')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'fieldset.tsx')
  ...
  it('should be in category: forms', () => {
    expect('forms').toMatch(/^(text|layout|navigation|feedback|overlay|data|media|utility|inputs|forms|charts|ui)$/)
  })
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'fieldset.tsx')
