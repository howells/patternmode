...
describe('ScrollArea Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'scroll-area')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'scroll-area.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'scroll-area.tsx')
