...
describe('Progress Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'progress')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'progress.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'progress.tsx')
