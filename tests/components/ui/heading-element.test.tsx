...
describe('HeadingElement Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'heading-element')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'heading-element.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'heading-element.tsx')
