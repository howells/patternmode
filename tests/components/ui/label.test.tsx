...
describe('Label Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'label')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'label.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'label.tsx')
