...
describe('Carousel Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'carousel')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'carousel.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'carousel.tsx')
