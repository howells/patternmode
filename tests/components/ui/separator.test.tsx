...
describe('Separator Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'separator')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'separator.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'separator.tsx')
