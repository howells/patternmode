...
describe('Radio Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'radio')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'radio.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'radio.tsx')
