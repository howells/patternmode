...
describe('Meter Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'meter')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'meter.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'meter.tsx')
