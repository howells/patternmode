...
describe('Menu Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'menu')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'menu.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'menu.tsx')
