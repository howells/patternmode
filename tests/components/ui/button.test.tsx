...
describe('Button Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'button')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'button.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'button.tsx')
