...
describe('Inspector Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'inspector')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'inspector.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'inspector.tsx')
