...
describe('Collapsible Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'collapsible')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'collapsible.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'collapsible.tsx')
