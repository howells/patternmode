...
describe('ContextMenu Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'context-menu')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'context-menu.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'context-menu.tsx')
