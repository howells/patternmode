...
describe('Combobox Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'combobox')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'combobox.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'combobox.tsx')
