...
describe('Sidebar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'sidebar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'sidebar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'sidebar.tsx')
