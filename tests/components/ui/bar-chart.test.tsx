...
describe('BarChart Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'bar-chart')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'bar-chart.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'bar-chart.tsx')
