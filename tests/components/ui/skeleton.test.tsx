...
describe('Skeleton Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'skeleton')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'skeleton.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'skeleton.tsx')
