...
describe('Tracker Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'tracker')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'tracker.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'tracker.tsx')
