...
describe('Textarea Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'textarea')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'textarea.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'textarea.tsx')
