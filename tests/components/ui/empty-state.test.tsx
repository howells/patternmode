...
describe('EmptyState Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'empty-state')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'empty-state.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'empty-state.tsx')
