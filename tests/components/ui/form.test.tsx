...
describe('Form Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'form')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'form.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'form.tsx')
