...
describe('Table Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'table')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'table.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'table.tsx')
