...
describe('Command Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'command')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'command.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'command.tsx')
