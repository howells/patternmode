...
describe('Tooltip Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'tooltip')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'tooltip.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'tooltip.tsx')
