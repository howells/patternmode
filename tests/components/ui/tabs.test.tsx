...
describe('Tabs Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'tabs')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'tabs.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'tabs.tsx')
