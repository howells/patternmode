...
describe('Toolbar Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'toolbar')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'toolbar.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'toolbar.tsx')
