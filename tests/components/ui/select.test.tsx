...
describe('Select Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'select')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'select.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'select.tsx')
