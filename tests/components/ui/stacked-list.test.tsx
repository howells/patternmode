...
describe('StackedList Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'stacked-list')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'stacked-list.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'stacked-list.tsx')
