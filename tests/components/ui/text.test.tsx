...
describe('Text Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'text')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'text.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'text.tsx')
