...
describe('Grid Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'grid')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'grid.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'grid.tsx')
