...
describe('DateRangePicker Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'date-range-picker')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'date-range-picker.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'date-range-picker.tsx')
