...
describe('TagInput Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'tag-input')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'tag-input.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'tag-input.tsx')
