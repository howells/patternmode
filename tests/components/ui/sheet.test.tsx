...
describe('Sheet Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'sheet')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'sheet.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'sheet.tsx')
