...
describe('Breadcrumbs Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'breadcrumbs')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'breadcrumbs.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'breadcrumbs.tsx')
