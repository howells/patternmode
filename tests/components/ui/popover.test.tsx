...
describe('Popover Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'popover')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'popover.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'popover.tsx')
