...
describe('Input Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'input')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'input.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'input.tsx')
