...
describe('SparkChart Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'spark-chart')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'spark-chart.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'spark-chart.tsx')
