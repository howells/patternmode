...
describe('SplitButton Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'split-button')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'split-button.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'split-button.tsx')
