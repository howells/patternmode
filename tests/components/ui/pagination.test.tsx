...
describe('Pagination Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'pagination')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'pagination.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'pagination.tsx')
