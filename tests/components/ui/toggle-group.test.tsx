...
describe('ToggleGroup Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'toggle-group')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'toggle-group.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'toggle-group.tsx')
