...
describe('Checkbox Component', () => {
  const componentDir = join(process.cwd(), 'src', 'components', 'ui', 'checkbox')
  ...
  it('should have main component file', () => {
    const componentFile = join(componentDir, 'checkbox.tsx')
  ...
  it('should be importable directly from component file', async () => {
    try {
      ...
      const componentPath = join(componentDir, 'checkbox.tsx')
