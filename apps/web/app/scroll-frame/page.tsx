...
import { ScrollFrameDemo } from "@/components/scroll-frame-demo";
...
const scrollFrameExample = `import { ScrollFrame } from "@howells/scroll-frame";
	...
	return (
		...
		>
			...
			<DocsBlock title="Install">
				<CodeBlock install>npm install @howells/scroll-frame</CodeBlock>
