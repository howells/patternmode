      ...
      <CollapsibleTrigger asChild>
        ...
        >
          <Icon
            ...
            size="2xs"
          />
          <span className="flex-1 truncate">cosmos-prod</span>
          <Icon
        ...
        <Collapsible defaultOpen>
          <CollapsibleTrigger asChild>
            ...
            >
              ...
              <Text className="tabular-nums" size="2xs" variant="muted">
                {COLLECTIONS.length}
              </Text>
            </button>
          </CollapsibleTrigger>
    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="w-44">createdAt</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {documents.map((doc) => (
          ...
          >
            ...
            <TableCell>
              <Text className="font-mono" size="2xs" variant="muted">
                {doc.createdAt}
              </Text>
            </TableCell>
          </TableRow>
...
export default function CosmosDemo() {
  ...
  return (
    <Flex fullHeight>
      ...
      {/* ----------------------------------------------------------------- */}
      <VStack
        className="w-[240px] shrink-0 border-r border-border bg-card"
        gap="none"
      >
        {/* Database header */}
        <Flex
          ...
          <div className="relative isolate grid flex-1 overflow-hidden">
            ...
            <TabsContent value="documents">
              <VStack className="bg-background" grow gap="none">
                ...
                >
                  <HStack align="center" gap="xs">
                    <Text className="font-mono" size="xs" weight="medium">
                      {activeCollection}
                    </Text>
                    <Text size="2xs" variant="muted">
      ...
      {/* ----------------------------------------------------------------- */}
      <VStack
        className="w-[280px] shrink-0 border-l border-border bg-card"
        gap="none"
      >
        <Flex
          align="center"
