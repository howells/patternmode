...
const productConfigSchema = z.object({
  ...
  quantity: z
    .number()
    .min(100, "Minimum order is 100 units")
    .max(1_000_000, "Maximum order is 1,000,000 units"),
});
...
const ComposedCardHeader = ({
  ...
  Icon: LucideIcon;
  iconVariant: GlobalSemanticVariant;
  heading: string;
  description: string;
}) => {
  return (
    <CardHeader border>
      <HStack align="center" gap={3}>
        <IconContainer icon={Icon} size="sm" variant={iconVariant} />
        <VStack gap={1}>
...
export default function FormsPage() {
  type RenderArgs = { ref: React.RefObject<any> } & Record<string, any>;
  ...
  const handleSubmit =
    (formType: string) => async (data: Record<string, unknown>) => {
    ...
    <>
      ...
      <VStack gap={8} padding={8}>
        ...
        <Card>
          <CardHeader border>
            <HStack align="center" gap={3}>
              <IconContainer icon={Factory} size="sm" variant="info" />
              <VStack gap={1}>
                <CardHeading>Company Information</CardHeading>
                <CardDescription>
                  Basic input components with validation
                </CardDescription>
              </VStack>
            </HStack>
          </CardHeader>
          <CardContent>
            ...
            <Form
              onValidSubmit={handleSubmit("company")}
                  ...
                  <GridCell>
                    <FormField name="contactPerson">
                      <VStack gap={2}>
                        ...
                        <FormControl>
                          <Input placeholder="John Smith" prefixIcon={User} />
                        </FormControl>
                        <FormDescription>
        ...
        <Card>
          <CardHeader border>
            <HStack align="center" gap={3}>
              <IconContainer icon={Package} size="sm" variant="success" />
              <VStack gap={1}>
                <CardHeading>Product Configuration</CardHeading>
                <CardDescription>
                  Select components, number fields, and tag inputs
                </CardDescription>
              </VStack>
            </HStack>
          </CardHeader>
          <CardContent>
            ...
            <Form
              onValidSubmit={handleSubmit("product")}
                  ...
                  <GridCell>
                    <Field name="quantity">
                      <VStack gap={2}>
                        ...
                        <FieldControl
                          render={(args) => {
                            const { ref, ...props } = args as RenderArgs;
                    ...
                    <FormControl>
                      <TagInput
                        ...
                        onValueChange={(values) =>
                          setProductData((prev) => ({ ...prev, color: values }))
                        }
        ...
        <Card>
          <ComposedCardHeader
            description="Sliders, checkboxes, and text areas"
            heading="Quality Control Specifications"
            Icon={Settings}
            iconVariant="warning"
          />
          <CardContent>
            ...
            <Form
              onValidSubmit={handleSubmit("quality")}
              ...
              <VStack gap={6}>
                <VStack gap={4}>
                  <Field name="tensileStrength">
                    <VStack gap={2}>
                      <FieldLabel>
                        Tensile Strength Requirement (1-10)
                      </FieldLabel>
                      <FieldControl
                        render={(args) => {
                          const { ref, ...props } = args as RenderArgs;
                          ...
                          return (
                            <Slider
                              ...
                              onValueChange={(value) =>
                                setQualityData((prev) => ({
                                  ...prev,
                                  tensileStrength: (Array.isArray(value)
                                    ? value[0]
                                    : value) as number,
                                }))
                              }
                      ...
                      />
                      <FieldDescription>
                        Required strength for paperclip durability (higher =
                        stronger)
                      </FieldDescription>
                      <FieldError />
                    </VStack>
                          ...
                          return (
                            <Slider
                              ...
                              onValueChange={(value) =>
                                setQualityData((prev) => ({
                                  ...prev,
                                  corrosionResistance: (Array.isArray(value)
                                    ? value[0]
                                    : value) as number,
                                }))
                              }
                          ...
                          return (
                            <Slider
                              ...
                              onValueChange={(value) =>
                                setQualityData((prev) => ({
                                  ...prev,
                                  bendability: (Array.isArray(value)
                                    ? value[0]
                                    : value) as number,
                                }))
                              }
                ...
                <FormField name="specialRequirements">
                  <VStack gap={2}>
                    ...
                    <FormDescription>
                      Additional specifications or custom requirements for your
                      order
                    </FormDescription>
                    <FormError />
                  </VStack>
        ...
        <Card>
          <CardHeader border>
            <HStack align="center" gap={3}>
              <IconContainer icon={TrendingUp} size="sm" variant="positive" />
              <VStack gap={1}>
                <CardHeading>Production Preferences</CardHeading>
                <CardDescription>
                  Switches, radio groups, and agreement checkboxes
                </CardDescription>
              </VStack>
            </HStack>
          </CardHeader>
          <CardContent>
            ...
            <Form
              onValidSubmit={handleSubmit("preferences")}
              schema={productionPreferencesSchema}
            >
              <VStack gap={6}>
                <Field name="rushOrder">
                  <HStack align="center" gap={3}>
                    ...
                    <VStack gap={1}>
                      ...
                      <FieldDescription>
                        Expedite production for faster delivery (additional
                        charges apply)
                      </FieldDescription>
                    </VStack>
                  </HStack>
                  ...
                  <Field name="newsletter">
                    <HStack align="center" gap={3}>
                      ...
                      <VStack gap={1}>
                        ...
                        <FieldDescription>
                          Receive updates about new paperclip designs and
                  ...
                  <FormField name="terms">
                    <HStack align="start" gap={3}>
                      ...
                      <VStack gap={1}>
                        ...
                        <FormDescription>
                          I agree to the Manufacturing Terms and Quality
                          Assurance Policy
                        </FormDescription>
                        <FormError />
                      </VStack>
        ...
        <Card>
          <CardHeader border>
            <HStack align="center" gap={3}>
              <IconContainer icon={Clipboard} size="sm" variant="neutral" />
              <VStack gap={1}>
                <CardHeading>Form Components Demonstrated</CardHeading>
                <CardDescription>
                  Complete overview of all form components used
                </CardDescription>
              </VStack>
            </HStack>
          </CardHeader>
